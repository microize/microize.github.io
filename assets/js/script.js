...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (relatedPostsGrid) {
    ...
    // Sample blog posts data (in a real implementation, this would come from your CMS/API)
    const allPosts = [
      {
        title: 'The Future of Data Engineering Leadership',
        slug: '2024-08-15-future-of-data-engineering-leadership',
        date: '2024-08-15',
        excerpt: 'Strategic insights on how data engineering leadership is evolving in the age of AI.',
        tags: ['leadership', 'future-of-work', 'data-engineering', 'ai-transformation']
      },
      {
        title: 'Cloud Cost Optimization for Data Platforms',
        slug: '2024-07-29-cloud-cost-optimization-data-platforms',
        date: '2024-07-29',
        excerpt: '$3M saved through strategic resource management and optimization techniques.',
        tags: ['cloud-cost', 'optimization', 'azure', 'data-platform', 'finops']
      },
      {
        title: 'Building Automated Data Quality Framework',
        slug: '2024-07-12-data-quality-automation-framework',
        date: '2024-07-12',
        excerpt: 'From 60% to 99.5% data accuracy through comprehensive automation.',
        tags: ['data-quality', 'automation', 'monitoring', 'data-engineering']
      },
      {
        title: 'Modern Data Stack 2024: What Changed',
        slug: '2024-06-25-modern-data-stack-2024',
        date: '2024-06-25',
        excerpt: 'Evolution of data stack technologies and what to expect next.',
        tags: ['modern-data-stack', 'data-platform', 'technology-trends', '2024']
      },
      {
        title: 'Data Mesh Implementation Lessons',
        slug: '2024-06-08-data-mesh-implementation-lessons',
        date: '2024-06-08',
        excerpt: '3 years of lessons from a Fortune 500 data mesh deployment.',
        tags: ['data-mesh', 'architecture', 'enterprise', 'data-platform']
      },
      {
        title: 'GenAI in Enterprise Implementation',
        slug: '2024-05-22-genai-enterprise-implementation',
        date: '2024-05-22',
        excerpt: 'Building production-ready AI systems that actually work in enterprise.',
        tags: ['genai', 'azure-openai', 'enterprise', 'ai-implementation']
      }
    ];
  ...
  function findRelatedPosts(posts, currentTags, currentSlug, maxResults = 3) {
    const scored = posts
      ...
      .filter(post => post.score > 0) // Only posts with shared tags
